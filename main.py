...
def main():
    ...
    for i in range(group_member_num):
        ...
        for u in matching_name:
            ...
            group_on_each_time[time].append(name)
    ...
    for each_time in group_on_each_time:
        ...
        for i in range(group_member_num):
            ...
            edges_to_remove = tuple((x[employee_weight.v_row], y)
                                    for x in matching_index for y in range(employee_weight.col_cnt))
    ...
    return group_on_each_place_on_each_time
